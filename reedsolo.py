...
def gf_mult_noLUT_slow(x, y, prim=0): # default prim=0
...
# added prim element to multiply by i+fcr for ccsds compliance - 31.Aug.2020 Drew Johnson
def rs_generator_poly(nsym, fcr=0, generator=2, prim=11):
    '''Generate an irreducible generator polynomial (necessary to encode a message into Reed-Solomon)'''
    g = _bytearray([1])
    for i in xrange(nsym):
        g = gf_poly_mul(g, [1, gf_pow(generator, (i+fcr)*prim)])
    return g
